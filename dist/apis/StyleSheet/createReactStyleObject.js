...
var applyPlugins=function applyPlugins(style){return plugins.reduce(function(style,plugin){return plugin(style);},style);};

var createReactDOMStyleObject=function createReactDOMStyleObject(reactNativeStyle){return applyPlugins((0,_expandStyle2.default)((0,_flattenStyle2.default)(reactNativeStyle)));};
